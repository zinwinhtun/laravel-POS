                        ...
                        <div class="col-4 offset-8">
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <span class="text-muted"><i
                                        class="fa-solid fa-check me-2"></i>{{ session('updateSuccess') }}</span>
                    ...
                    <div class="card">
                        <div class="card-body ">
                            <div class="card-title">
                                <h3 class="text-center  title-2">Account view or Edit <i
                                        class="fa-solid fa-file-pen me-2"></i></h3>
                            </div>
                            <hr>
                                    ...
                                    <div class="col-4 offset-1 mt-4">
                                        <div class="text-center my-5">
                                            @if (Auth::user()->image == null)
                                                <img src=" {{ asset('image/user.png') }}" class="img-thumbnail shadow"
                                                    alt="Cool Admin" />
                                            @else
                                                <img src=" {{ asset('storage/' . Auth::user()->image) }}" class="img-thumbnail shadow w-100"
                                                    alt="John Doe" />
                                            @endif
                                        </div>
